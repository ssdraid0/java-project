...
public final class String implements java.io.Serializable, Comparable<String>, CharSequence
{
    ...
    /**
     * 用于缓存哈希码，int默认值为0。Cache the hash code for the string
     */
    ...
    /**
     * 判断和Object对象是否相同 </br>
     * 1.先比较引用，引用相同返回true。 </br>
     * 2.再判断Object对象是否为String类型，不是返回false。 </br>
     * 3.再判断长度是否相同，不相同返回false。 </br>
     * 4.再从头开始比较每个字符。 </br>
    ...
    /**
     * 从第一位开始比较char数组,如果遇到不同的字符,则马上返回这两个字符的ascii值的差值。如果其中较短的char数组比较完了还没有遇到不同的字符
     * ,返回长度差。
     * <p>
    ...
    /**
     * 返回一个新的String，这个String中的oldChar都被替换为newChar。
     * <p>
    ...
    /**
     * 如果常量池已经包含一个等于此 String 对象的字符串（该对象由 equals(Object) 方法确定），则返回常量池中的字符串。否则，将此
     * String 对象添加到常量池中，并且返回此 String 对象的引用。
     * <p>
