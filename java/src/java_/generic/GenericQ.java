 ...
 * 2.下面的代码{@link GenericQ#test1()}能否运行？为什么？如何修改才能运行？<br>
 * 不能。因为{@link List}在声明时没有指定到底要添加Fruit的哪种子类。要改成{@link GenericQ#test2()}。<br>
 * 3.下面的代码{@link GenericQ#test3()}的运行结果是什么？为什么？<br>
